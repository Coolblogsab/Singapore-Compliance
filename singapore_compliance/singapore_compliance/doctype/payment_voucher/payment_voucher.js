...
frappe.ui.form.on("Payment Voucher", {
	refresh: function (frm) {
		frm.add_custom_button(__("Download"), function () {
			frappe.call({
				method: "singapore_compliance.singapore_compliance.doctype.payment_voucher.payment_voucher.get_supplier_payments",
				args: {
	...
	<tbody>
		<tr>
			<td>
				...
				<p class="address-sec">${r.address.city ? r.address.city : ""} ${
		r.address.country ? r.address.country : ""
	} ${r.address.pincode ? r.address.pincode : ""} </p>
			</td>
			<td>
